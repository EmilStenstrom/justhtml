...
passes `3464/3464` tests with `6` expected skips.

The latest isolated default-safe web100k gate measures `0.524182s` median over
`31` iterations for 100 files, a `2.048x` speedup against the recorded `1.073689s`
